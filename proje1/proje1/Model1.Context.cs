...
namespace proje1
{
    ...
    public partial class UrunSatisEEntities : DbContext
    {
        public UrunSatisEEntities()
            : base("name=UrunSatisEEntities")
        {
        }
        ...
        public virtual ObjectResult<satislarinListesi_Result> satislarinListesi()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<satislarinListesi_Result>("satislarinListesi");
        }
    }
}
